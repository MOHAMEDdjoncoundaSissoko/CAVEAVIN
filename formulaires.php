...
//*********************************************************Formulaire de suppression Mohamed********************************************
    function FormulaireChoixVin(){
        ...
        <div class="wrapper">
            ...
            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                <fieldset> 
                    <select id="id_ProducteurAnneeNomVin" style="width: auto; height: 50px; margin-bottom:20px; margin-top:30px; display: block; margin-left: auto; margin-right: auto;" name="ProducteurAnneeNomVin" size="1">
                        <?php
                        foreach ($Vin as $vin) {
                            echo "<option value='" . $vin['Producteur'] .' - '. $vin['Annee'] .' - '. $vin['NomVin'] . "'>" . $vin['Producteur'] .' - '. $vin['Annee'] .' - '. $vin['NomVin'] ."</option>";
                        }
